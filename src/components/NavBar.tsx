  ...
  return (
    <nav className='w-full flex py-6 justify-between items-center navbar'>
      ...
      <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        <img src={toggele ? close : menu} alt='menu' className='w-[28px] h-[28] object-contain' onClick={() => setToggele((previousToggelState) => !previousToggelState)}/>
        <div className={`${toggele ? 'flex' : 'hidden'} p-6 bg-black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl
        sidebar`}>
